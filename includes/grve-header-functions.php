...
<map name="image-map">
    <area target="_self" alt="Matfest 2020" title="Matfest 2020" href="https://matfest.no" coords="0,0,218,79" shape="rect">
    <area target="_self" alt="Norsk Siderfestival 2020" title="Norsk Siderfestival 2020" href="https://matfest.no/siderfestival/" coords="225,0,308,78" shape="rect">
</map>

			<div class="grve-logo øpepieriqejrqjrew <?php echo esc_attr( $align ); ?>">
...
?>
			<img class="<?php echo esc_attr( $logo_class ); ?>" src="<?php echo esc_url( $logo_url ); ?>"  alt="<?php echo esc_attr( get_bloginfo('name') ); ?>" <?php echo implode( ' ', $logo_attributes ); ?>usemap="#image-map">
            <img class="<?php echo esc_attr( $logo_class ); ?>" src="<?php echo esc_url( $logo_url ); ?>"  alt="<?php echo esc_attr( get_bloginfo('name') ); ?>" <?php echo implode( ' ', $logo_attributes ); ?>usemap="#image-map">
<?php
		}
 ...
 */
if ( !function_exists('movedo_grve_header_title') ) {
	function movedo_grve_header_title() {
		...
		if ( is_front_page() && is_home() ) {
			...
			if ( 'custom' === movedo_grve_option( 'blog_title' ) ) {
				$page_title = movedo_grve_option( 'blog_custom_title' );
				$page_description = movedo_grve_option( 'blog_custom_description' );
			}
...
if ( !function_exists('movedo_grve_print_title_bg_image') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_title') ) {
			...
			<div class="grve-wrapper clearfix" style="<?php echo esc_attr( $movedo_grve_wrapper_style ); ?>">
				...
				<div class="<?php echo esc_attr( $movedo_grve_content_container_classes ); ?>" data-animation="<?php echo esc_attr( $content_animation ); ?>">
					<div class="grve-container">
						...
						<?php do_action( 'movedo_grve_page_title_content_top' ); ?>
						...
						<?php } else { ?>
							...
							<<?php echo tag_escape( $title_tag ); ?> class="<?php echo esc_attr( $movedo_grve_title_classes ); ?>"><span><?php echo wp_kses_post( $header_title ); ?></span></<?php echo tag_escape( $title_tag ); ?>>
						<?php } ?>
						<?php do_action( 'movedo_grve_page_title_content_bottom' ); ?>
						</div>
					</div>
				</div>
 ...
 * Prints Anchor Menu
 */
if ( !function_exists('movedo_grve_print_anchor_menu') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_responsive_anchor_menu') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_breadcrumbs') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_text') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_nav') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_search') ) {
	function movedo_grve_print_header_top_bar_search( $position = 'left' ) {
?>
	<li class="grve-topbar-item grve-topbar-item-search"><a href="#grve-search-modal" class="grve-icon-search grve-toggle-modal" aria-label="<?php esc_html_e( 'Search', 'movedo' ); ?>"></a></li>
<?php
	}
}
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_form') ) {
...
?>
	<li class="grve-topbar-item grve-topbar-item-form"><a href="<?php echo esc_attr( $modal_id ); ?>" class="grve-icon-envelope grve-toggle-modal" aria-label="<?php esc_html_e( 'Form', 'movedo' ); ?>"></a></li>
<?php
	}
}
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_socials') ) {
		...
		if ( !empty( $options ) && !empty( $social_options ) ) {
			...
			foreach ( $social_options as $key => $value ) {
				if ( isset( $options[$key] ) && 1 == $options[$key] && $value ) {
					if ( 'skype' == $key ) {
						echo '<li><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '" class="fa fa-' . esc_attr( $key ) . '" aria-label="' . esc_attr( $movedo_grve_social_list[$key] ) . '"></a></li>';
					} else {
						echo '<li><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer" class="fa fa-' . esc_attr( $key ) . '" aria-label="' . esc_attr( $movedo_grve_social_list[$key] ) . '"></a></li>';
					}
				}
			}
			?>
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_language_selector') ) {
	...
	?>
		<li class="grve-topbar-item grve-topbar-item-language-selector">
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar_login') ) {
	...
	?>
		<li class="grve-topbar-item"><a href="<?php echo esc_url( $login_custom_link_url ); ?>" class="grve-icon-user" aria-label="<?php esc_html_e( 'Login', 'movedo' ); ?>"></a></li>
	<?php
		} else {
	?>
		<li class="grve-topbar-item"><a href="#grve-login-modal" class="grve-icon-user grve-toggle-modal" aria-label="<?php esc_html_e( 'Login', 'movedo' ); ?>"></a></li>
	<?php
		}
	}
}
 ...
 */
if ( !function_exists('movedo_grve_print_header_top_bar') ) {
 ...
 */
if ( !function_exists('movedo_grve_check_header_elements_visibility_any') ) {
...
if ( !function_exists('movedo_grve_check_header_elements_visibility') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_safebutton') ) {
	function movedo_grve_print_header_safebutton( $mode = '') {
		...
		if ( !empty( $movedo_area_id ) && 'none' != $movedo_area_id ) {
			$movedo_area_id = apply_filters( 'wpml_object_id', $movedo_area_id, 'area-item', TRUE  );
		?>
				<?php if ( empty( $mode ) ) { ?>
				<!-- Safe Button -->
 ...
 */
if ( !function_exists('movedo_grve_print_header_elements') ) {
				...
				if ( !empty( $header_menu_options ) ) {
					foreach ( $header_menu_options as $key => $value ) {
						if( !empty( $value ) && '0' != $value && movedo_grve_check_header_elements_visibility( $key ) ) {
							if ( 'search' == $key ) {
							?>
								<li class="grve-header-element"><a href="#grve-search-modal" class="grve-toggle-modal" aria-label="<?php echo esc_attr__( 'Search', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-search"></i></span></a></li>
							<?php
							} else if ( 'language' == $key ) {
							?>
								<li class="grve-header-element"><a href="#grve-language-modal" class="grve-toggle-modal" aria-label="<?php echo esc_attr__( 'Language Selector', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-globe"></i></span></a></li>
							<?php
							} else if ( 'login' == $key ) {
								$login_custom_link_url = movedo_grve_option( 'login_custom_link_url' );
								$login_mode = movedo_grve_option( 'login_mode', 'modal' );
								if ( 'custom-link' == $login_mode ) {
							?>
								<li class="grve-header-element"><a href="<?php echo esc_url( $login_custom_link_url ); ?>" aria-label="<?php echo esc_attr__( 'Login', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-user"></i></span></a></li>
							<?php
								} else {
							?>
								<li class="grve-header-element"><a href="#grve-login-modal" class="grve-toggle-modal" aria-label="<?php echo esc_attr__( 'Login', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-user"></i></span></a></li>
							<?php
								}
							} else if ( 'form' == $key ) {
							?>
								<li class="grve-header-element"><a href="#grve-menu-form-modal" class="grve-toggle-modal" aria-label="<?php echo esc_attr__( 'Form', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-envelope"></i></span></a></li>
							<?php
							} else if ( 'cart' == $key && movedo_grve_woocommerce_enabled() ) {
								global $woocommerce;
							?>
								<li class="grve-header-element">
									<a href="#grve-cart-area" class="grve-toggle-hiddenarea" aria-label="<?php echo esc_attr__( 'Cart', 'movedo' ); ?>">
										<span class="grve-item">
							...
							?>
								<li class="grve-header-element"><a href="#grve-socials-modal" class="grve-toggle-modal" aria-label="<?php echo esc_attr__( 'Social', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-socials"></i></span></a></li>
							<?php
								} else {
									...
									if ( !empty( $header_social_options ) && !empty( $social_options ) ) {
										...
										foreach ( $social_options as $key => $value ) {
											if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
												if ( 'skype' == $key ) {
													echo '<li class="grve-header-element"><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '" aria-label="' . esc_attr( $movedo_grve_social_list[$key] ) . '"><span class="grve-item"><i class="fa fa-' . esc_attr( $key ) . '"></i></span></a></li>';
												} else {
													echo '<li class="grve-header-element"><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer" aria-label="' . esc_attr( $movedo_grve_social_list[$key] ) . '"><span class="grve-item"><i class="fa fa-' . esc_attr( $key ) . '"></i></span></a></li>';
												}
											}
										}
 ...
 */
if ( !function_exists('movedo_grve_header_text_visibility') ) {
 ...
 * Prints header Text
 */
if ( !function_exists('movedo_grve_print_header_text') ) {
 ...
 * Prints header elements e.g: social, language selector, search
 */
if ( !function_exists('movedo_grve_print_header_elements_responsive') ) {
...
<?php
										foreach ( $social_options as $key => $value ) {
											if ( isset( $header_social_options[$key] ) && 1 == $header_social_options[$key] && $value ) {
												if ( 'skype' == $key ) {
													echo '<li class="grve-header-responsive-element"><a href="' . esc_url( $value, array( 'skype', 'http', 'https' ) ) . '" aria-label="' . esc_attr( $movedo_grve_social_list[$key] ) . '"><span class="grve-item"><i class="fa fa-' . esc_attr( $key ) . '"></i></span></a></li>';
												} else {
													echo '<li class="grve-header-responsive-element"><a href="' . esc_url( $value ) . '" target="_blank" rel="noopener noreferrer" aria-label="' . esc_attr( $movedo_grve_social_list[$key] ) . '"><span class="grve-item"><i class="fa fa-' . esc_attr( $key ) . '"></i></span></a></li>';
												}
											}
										}
?>
 ...
 * Prints Form modals
 */
if ( !function_exists('movedo_grve_print_contact_form') ) {
...
if ( !function_exists('movedo_grve_print_gravity_form') ) {
...
if ( !function_exists('movedo_grve_print_form_modals') ) {
 ...
 * Prints Search modal
 */
if ( !function_exists('movedo_grve_print_search_modal') ) {
	...
	?>
			<div id="grve-search-modal" class="grve-modal grve-<?php echo esc_attr( $movedo_grve_close_cursor_color ); ?>-cursor">
				<div class="grve-modal-wrapper">
					<div class="grve-modal-content">
						<div class="grve-modal-item">
							<?php echo movedo_grve_modal_wpsearch(); ?>
						</div>
					</div>
				</div>
			</div>
...
if ( !function_exists('movedo_grve_print_language_modal') ) {
...
if ( !function_exists('movedo_grve_print_login_modal') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_login_responsive_button') ) {
				...
				<div class="grve-wrapper">
					<ul>
						...
						<?php
							...
							if ( 'custom-link' == $login_mode ) {
						?>
							<a href="<?php echo esc_url( $login_custom_link_url ); ?>" aria-label="<?php esc_html_e( 'Login', 'movedo' ); ?>">
								<span class="grve-item"><i class="grve-icon-user"></i></span>
							</a>
						<?php
							} else {
						?>
							<a href="#grve-login-modal" class="grve-toggle-modal" aria-label="<?php esc_html_e( 'Login', 'movedo' ); ?>">
								<span class="grve-item"><i class="grve-icon-user"></i></span>
							</a>
						<?php
							}
...
if ( !function_exists('movedo_grve_print_social_modal') ) {
 ...
 * Gets side area data
 */
if ( !function_exists('movedo_grve_get_sidearea_data') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_header_sidearea_button') ) {
	...
	?>
			<li class="grve-header-element">
				<a href="#grve-sidearea" class="grve-sidearea-btn grve-toggle-hiddenarea" aria-label="<?php esc_html_e( 'Side area', 'movedo' ); ?>">
 ...
 */
if ( !function_exists('movedo_grve_print_header_hiddenarea_button') ) {
	...
	?>
		<div class="grve-hidden-menu-btn grve-position-right">
			<div class="grve-header-element">
				<a href="#grve-hidden-menu" class="grve-toggle-hiddenarea" aria-label="<?php echo esc_attr__( 'Menu', 'movedo' ); ?>">
 ...
 * Prints Side Area
 */
if ( !function_exists('movedo_grve_print_side_area') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_cart_responsive_link') ) {
	...
	?>
			<div class="grve-header-elements grve-position-right">
				<div class="grve-wrapper">
					<ul>
						<li class="grve-header-element">
							<a href="<?php echo esc_url( $get_cart_url ); ?>" aria-label="<?php echo esc_attr__( 'Cart', 'movedo' ); ?>">
								<span class="grve-item">
									<i class="grve-icon-shop"></i>
								</span>
							</a>
 ...
 * Prints Shop Cart
 */
if ( !function_exists('movedo_grve_print_cart_area') ) {
 ...
 * Prints Hidden Menu
 */
if ( !function_exists('movedo_grve_print_hidden_menu') ) {
...
if ( !function_exists('movedo_grve_print_item_nav_link') ) {
 ...
 */
if ( !function_exists('movedo_grve_check_theme_loader_visibility') ) {
 ...
 * Prints Theme Loader
 */
if ( !function_exists('movedo_grve_print_theme_loader') ) {
 ...
 */
if ( !function_exists('movedo_grve_print_safebutton_area') ) {
	...
	?>
		<div id="grve-safebutton-area">
			...
			<div class="grve-close-button-wrapper grve-position-right">
				<a href="#" class="grve-close-button" aria-label="<?php esc_html_e( 'Close', 'movedo' ); ?>"><span class="grve-item"><i class="grve-icon-close"></i></span></a>
			</div>
...
if ( !function_exists('movedo_grve_safebutton_area_css') ) {
...
if ( !function_exists('movedo_grve_bottom_bar_area_css') ) {
...
if ( !function_exists('movedo_grve_shop_css') ) {

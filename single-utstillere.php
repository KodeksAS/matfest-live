      ...
      <div id="grve-main-content">
        <div class="grve-main-content-wrapper clearfix">
          ...
          <div class="grve-container">
            ...
            <?php echo do_shortcode('[vc_row][vc_column][wppm post_type="utstillere" post_status="" num="50" terms="" hide_current_post="true" enable_slider="true" items="3" loop="true" animatein="" animateout="" imgwidth="600" imgheight="400" imgquality="85" xclass="no-border" hide_author="true" hide_date="true" ad_list="%5B%7B%7D%5D"][/vc_column][/vc_row]'); ?>

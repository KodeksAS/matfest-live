							...
							?>
		                            ...
		                            <?php endif; ?>
										...
										<figcaption class="<?php echo esc_attr( $portfolio_content_class_string ); ?>">
											...
											<?php if($dated){?>
                                            <span <?php echo $catz == 'norsk-siderfestival' ? 'style="color: #333; background-color:' . $colorz . '"' : ''; ?> class="grve-date grve-text-white grve-h4"><?php echo $dated;?><?php //echo get_the_date( 'd.F Y', $post_id );?></span>

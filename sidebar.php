...
if( 'search_page' == $sidebar_view  ) {
	...
	$movedo_grve_sidebar_id = movedo_grve_option( 'search_page_sidebar' );

	$movedo_grve_sidebar_layout = movedo_grve_option( 'search_page_layout', 'none' );

	$movedo_grve_fixed_sidebar = movedo_grve_option( 'search_page_fixed_sidebar', 'no' );
	...
	if( is_search() ) {
		...
		$movedo_grve_sidebar_id = movedo_grve_option( 'product_search_sidebar' );

		$movedo_grve_sidebar_layout = movedo_grve_option( 'product_search_layout', 'none' );

		$movedo_grve_fixed_sidebar = movedo_grve_option( 'product_search_fixed_sidebar', 'no' );
